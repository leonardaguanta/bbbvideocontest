    ...
    <div id="footer-bottom">
        <div class="container clearfix">
            ...
            <div>
                ...
                <p id="copyright"><a href="<?php echo esc_url( home_url( '/privacy-policy/' ) ); ?>">Privacy Policy</a>&nbsp;|&nbsp;<a href="<?php echo esc_url( home_url( '/bbb-admin-dashboard/' ) ); ?>">BBB Admin Dashboard</a></p>
                <?php
            }?>
        ...
        <p id="copyright"><a href="<?php echo esc_url( home_url( '/privacy-policy/' ) ); ?>">Privacy Policy</a>&nbsp;|&nbsp;<a href="<?php echo esc_url( home_url( '/student-home/' ) ); ?>">Dashboard</a></p>
        <?php
    }?>                         
    <?php
    if( !is_user_logged_in() ) {?>
    <p id="copyright"><a href="<?php echo esc_url( home_url( '/privacy-policy/' ) ); ?>">Privacy Policy</a>&nbsp;|&nbsp;<a href="#" class="lrm-login">BBB Admin</a></p>
    <?php
}?>
