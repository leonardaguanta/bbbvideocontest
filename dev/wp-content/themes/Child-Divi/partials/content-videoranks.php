<?php
    ...
    if( $videos->have_posts() ) : ?>
        ...
        <div class="my-posts clearfix videos-page" id="ajax-posts" data-page="<?php echo $videos->max_num_pages; ?>">
        ...
        ?>
            ...
            <div class="video-feed" data-video-name="<?php echo $videoName;?>" data-href="<?php the_permalink(); ?>" data-id="<?php get_the_ID(); ?>" data-url="<?php echo $href; ?>" title="<?php  echo get_the_title();?>" data-modal-id="modal-video" data-link="<?php the_permalink(); ?>">                
