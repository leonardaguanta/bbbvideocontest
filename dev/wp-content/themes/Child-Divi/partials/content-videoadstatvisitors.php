                    ...
                    <table class="visitorsTable">
                        <tbody>
                            <tr class="greyRow vistorsTableRow">
                                <td>
                                    <span class="visitorInfoTitle">Website Visits</span>
                                </td>
                                <td>
                                    <span class="visitorInfoValue">'.$sessions.'</span>
                                </td>
                            </tr>
                            <tr class="whiteRow vistorsTableRow">
                                <td>
                                    <span class="visitorInfoTitle">Unique Visitors</span>
                                </td>
                                <td>
                                    <span class="visitorInfoValue">'.$uniqueVisitors.'</span>
                                </td>
                            </tr>
                            <tr class="greyRow vistorsTableRow">
                                <td>
                                    <span class="visitorInfoTitle">Page Views</span>
                                </td>
                                <td>
                                    <span class="visitorInfoValue">'.$pageViews.'</span>
                                </td>
                            </tr>
                            <tr class="whiteRow vistorsTableRow">
                                <td>
                                    <span class="visitorInfoTitle">Bounce Rate</span>
                                </td>
                                <td>
                                    <span class="visitorInfoValue">'.$bounceRate.'%</span>
                                </td>
                            </tr>
                            <tr class="greyRow vistorsTableRow">
                                <td>
                                    <span class="visitorInfoTitle">% New Visits</span>
                                </td>
                                <td>
                                    <span class="visitorInfoValue">'.$percentNewVisits.'%</span>
                                </td>
                            </tr>
                            <tr class="whiteRow vistorsTableRow">
                                <td>
                                    <span class="visitorInfoTitle">Average Time On Site</span>
                                </td>
                                <td>
                                    <span class="visitorInfoValue">'.$avgTimeOnSite.'m</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
