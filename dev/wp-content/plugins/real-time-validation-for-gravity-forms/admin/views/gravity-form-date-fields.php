...
<li class="gf_live_validation_type_settings_is_date_error field_setting " style="display: none;">
    ...
    <input type="text" class="gf_live_validation_error_msg_fields" id="gf_live_validation_error_msg_date_0" onkeyup="SetFieldProperty('gf_live_validation_error_msg_date_0', moveErrorTohidden(this));" />
...
<li class="gf_live_validation_type_settings_is_date_error field_setting " style="display: none;">
    ...
    <input type="text" class="gf_live_validation_error_msg_fields" id="gf_live_validation_error_msg_date_1" onkeyup="SetFieldProperty('gf_live_validation_error_msg_date_1', moveErrorTohidden(this));" />
...
<li class="gf_live_validation_type_settings_is_date_error field_setting " style="display: none;">
    ...
    <input type="text" class="gf_live_validation_error_msg_fields" id="gf_live_validation_error_msg_date_2" onkeyup="SetFieldProperty('gf_live_validation_error_msg_date_2', moveErrorTohidden(this));" />
