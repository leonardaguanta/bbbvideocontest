...
function loadPASPopup( adzone_id, popup_type, ajaxurl, cookie ) {
...
/************** start: exit popup functions. **************/
/*function loadPASExitPopup( adzone_id, popup_type, ajaxurl ) {

	jQuery(function($){
		
	});
}*/
/************** end: exit popup functions. **************/
