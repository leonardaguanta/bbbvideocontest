...
<table class="form-table">
	<tbody>
		...
		<tr class="flowplayer-drive" valign="top">
                        <th scope="row"><?php _e( 'Video Description', $this->plugin_slug )?> </th>
                        <td>
				<input type="text" name="fp5-video-description" id="fp5-video-description" placeholder="<?php _e( 'Video Description', $this->plugin_slug )?>" value="<?php if ( isset ( $fp5_stored_meta['fp5-video-description'] ) ) echo esc_attr( $fp5_stored_meta['fp5-video-description'][0] ); ?>" />
                        </td>
                </tr>

		<tr class="flowplayer-drive" valign="top">
                        <th scope="row"><?php _e( 'Video School Id', $this->plugin_slug )?> </th>
                        <td>
                                <input type="text" name="fp5-video-school-id" id="fp5-video-school-id" placeholder="<?php _e( 'Video School Id', $this->plugin_slug )?>" value="<?php if ( isset ( $fp5_stored_meta['fp5-video-school-id'] ) ) echo esc_attr( $fp5_stored_meta['fp5-video-school-id'][0] ); ?>" />
                        </td>
                </tr>
