...
flowplayer.engine.html5 = function(player, root) {
   ...
   return self = {
      ...
      pause: function() {
         if(typeof api === 'undefined' && videoTag[0]) api = videoTag[0];
         api.pause();
      },
...
flowplayer(function(player, root) {
   ...
   var conf = player.conf,
      ...
      target = $("<div/>", { 'class': 'fp-embed-code'})
         .append("<label>Share this video:<br> "+$(location).attr('href')+"</label><br><label>Paste this HTML code on your site to embed.</label><textarea/><br><a target='_blank' href='http://www.facebook.com/sharer.php?s=100&p[title]=&p[url]="+$(location).attr('href')+"' alt='Share this video on Facebook'><img src='http://platypus-dallas.s3.amazonaws.com/wp-content/uploads/2015/11/10183344/FB-f-Logo.png' border='0'></a><a target='_blank' href='https://twitter.com/share?url="+$(location).attr('href')+"' alt='Tweet this video'><img src='http://platypus-dallas.s3.amazonaws.com/wp-content/uploads/2015/11/10184606/TwitterLogo.png' border='0'></a><a target='_blank' href='https://plus.google.com/share?url="+$(location).attr('href')+"' alt='Add to Google+'><img src='http://platypus-dallas.s3.amazonaws.com/wp-content/uploads/2015/11/10183349/btn_google.png' border='0'></a>").appendTo(ui),
