 ...
 * Typical Usage:
 *
 *   $browser = new Pro_Ads_Browser();
 *   if( $browser->getBrowser() == Pro_Ads_Browser::BROWSER_FIREFOX && $browser->getVersion() >= 2 ) {
...
class Pro_Ads_Browser
{
    ...
    public function Pro_Ads_Browser($userAgent = "")
    {
        $this->reset();
        if ($userAgent != "") {
