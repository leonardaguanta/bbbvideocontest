...
if (!function_exists('ual_user_activity')):
    ...
    function ual_user_activity() {
        add_menu_page(__('User Action Log', 'wp_user_log'), __('User Action Log', 'wp_user_log'), 'manage_options', 'user_action_log', 'ual_user_activity_function', 'dashicons-admin-users');
                ...
                <table class="widefat post fixed striped" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="sol-col-width"><?php _e('Email address', 'wp_user_log'); ?></th>
                            <th scope="col"><?php _e('IP', 'wp_user_log'); ?></th>
                            <th scope="col"><?php _e('Type', 'wp_user_log'); ?></th>
                            <th scope="col"><?php _e('Action', 'wp_user_log'); ?></th>
                            <th scope="col" class="sol-col-width"><?php _e('Description', 'wp_user_log'); ?></th>
                        </tr>
                    </thead>
                    <tfoot>
                        <tr>
