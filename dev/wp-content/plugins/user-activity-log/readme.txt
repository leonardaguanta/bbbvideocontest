...
Tags: admin user log, user log, user, log, user activity, activity log, log user, record user activity, log user action, user action log, wordpress admin security, wordpress security, security, user tracking, watch user, track user, track user activity, track activity.
...
* Bug Fix: Email settings and security
