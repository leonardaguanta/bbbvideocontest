...
class Flowplayer5_Frontend {
	...
	public function __construct() {
		...
		if ( is_file( $flowplayer5_commercial ) && ! $cdn && $key ) {
			...
			$this->flowplayer5_directory = $http.'//releases.flowplayer.org/' . $this->player_version . '/'. ( $key ? 'commercial' : '' );
		}
	...
	public function enqueue_scripts() {
		...
		wp_register_script( $this->plugin_slug . '-script', plugin_dir_url( __FILE__ ) . 'assets/flowplayer/flowplayer.js');
	...
	public function has_flowplayer_video() {
		...
		////////////////////
		// #Platypus Edited
		if ( is_page_template( 'page-template-student.php' ) || is_page_template( 'page-template-admin.php' ) || is_front_page() || is_page('student-video')) {
			$this->has_flowplayer_video = 'flowplayer5';
		}
	}
