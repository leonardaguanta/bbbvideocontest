...
<p class="pfg_settings pfg_border">
	<p class="bg-title"><?php _e('1. Filter Gallery Thumbnail Size', PFG_TXTDM); ?></p>
	...
	<div class="pfg_spacing_md">
		<select id="gal_size" name="gal_size" class="selectbox_settings">
			<option value="thumbnail" <?php if($gal_size == "thumbnail") echo "selected=selected"; ?>><?php _e('Thumbnail - 150 x 150', PFG_TXTDM); ?></option>
			<option value="medium" <?php if($gal_size == "medium") echo "selected=selected"; ?>><?php _e('Medium - 300 x 169', PFG_TXTDM); ?></option>
			<option value="large" <?php if($gal_size == "large") echo "selected=selected"; ?>><?php _e('Large - 840 x 473', PFG_TXTDM); ?></option>
			<option value="full" <?php if($gal_size == "full") echo "selected=selected"; ?>><?php _e('Full Size - 1280 x 720', PFG_TXTDM); ?></option>
		</select><br><br>
...
<p class="pfg_settings pfg_border">
	...
	<p class="bg-title"><?php _e('2. Columns Settings', PFG_TXTDM); ?></p>
	<div class="pfg_spacing_md">
		<p class="bg-lower-title"><?php _e('Columns On Large Desktops', PFG_TXTDM); ?></p>
		...
		<select id="col_large_desktops" name="col_large_desktops" class="selectbox_settings">
			<option value="col-lg-6" <?php if($col_large_desktops == "col-lg-6") echo "selected=selected"; ?>><?php _e('2 Column', PFG_TXTDM); ?></option>
			<option value="col-lg-4" <?php if($col_large_desktops == "col-lg-4") echo "selected=selected"; ?>><?php _e('3 Column', PFG_TXTDM); ?></option>
		</select><br><br>
		<p class="pfg_cmnt_setting"><?php _e('Select filter gallery column layout for large desktop devices', PFG_TXTDM); ?></p>

		<p class="bg-lower-title"><?php _e('Columns On Desktops', PFG_TXTDM); ?></p>
		...
		<select id="col_desktops" name="col_desktops" class="selectbox_settings">
			<option value="col-md-6" <?php if($col_desktops == "col-md-6") echo "selected=selected"; ?>><?php _e('2 Column', PFG_TXTDM); ?></option>
			<option value="col-md-4" <?php if($col_desktops == "col-md-4") echo "selected=selected"; ?>><?php _e('3 Column', PFG_TXTDM); ?></option>
		</select><br><br>
		<p class="pfg_cmnt_setting"><?php _e('Select filter gallery column layout for desktop devices', PFG_TXTDM); ?></p>



		<p class="bg-lower-title"><?php _e('Columns On Tablets', PFG_TXTDM); ?></p>
		...
		<select id="col_tablets" name="col_tablets" class="selectbox_settings">
			<option value="col-sm-6" <?php if($col_tablets == "col-sm-12") echo "selected=selected"; ?>><?php _e('2 Column', PFG_TXTDM); ?></option>
			<option value="col-sm-4" <?php if($col_tablets == "col-sm-4") echo "selected=selected"; ?>><?php _e('3 Column', PFG_TXTDM); ?></option>
		</select><br><br>
		<p class="pfg_cmnt_setting"><?php _e('Select filter gallery column layout for tablet devices', PFG_TXTDM); ?></p>

		<p class="bg-lower-title"><?php _e('Columns On Phones', PFG_TXTDM); ?></p>
		...
		<select id="col_phones" name="col_phones" class="selectbox_settings">
			<option value="col-xs-6" <?php if($col_phones == "col-xs-6") echo "selected=selected"; ?>><?php _e('2 Column', PFG_TXTDM); ?></option>
			<option value="col-xs-4" <?php if($col_phones == "col-xs-4") echo "selected=selected"; ?>><?php _e('3 Column', PFG_TXTDM); ?></option>
		</select><br><br>
