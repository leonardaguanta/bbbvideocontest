...
<div class="wrap">
	<h2 class="hndle text-center" style="background-color: #073b4c;"><span>Get More Free WordPress Plugin From A WP Life</span></h2>	
								...
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-12 text-center custom-buy-button">
											<a href="http://awplife.com/plugins/" target="_blank" class="btn btn-info btn-circle btn-xl"><i class="glyphicon glyphicon-shopping-cart"></i> Buy Now</a>
										</div>
									</div>
									<hr>
								</div>
