...
<div class="rmagic">
    ...
    <div class="rm-submission"> 
               ...
               <div class="rm-submission-field-row rm-submission-status-row">
                <div class="rm-submission-label rm-custom_status-wrap">
                    <div class="rm-custom-status-lf"><div class="rm-no-status-assigned"> No Status Assigned </div></div>
                    <div class="rm-submission-value rm-custom-status-lr">
                        <span class="rm-add-custom-status"><i class="material-icons">&#xE145;</i></span>
                        <div class="rm-submission-value rm-add-custom-status-value" style="display:none">
                            <span class="rm-custom-status-box-nub"></span>
                           <span class="rm_buy_pro_inline">To unlock Custom Statuses (and many more), please upgrade <a href="http://registrationmagic.com/?download_id=317&amp;edd_action=add_to_cart" target="blank">Click here</a></span>
                           <div class="rm-custom-status-ext-link"><a href="https://registrationmagic.com/custom-status-guide-tag-label-user-data-execute-multiple-actions" target="blank">Learn how to boost your productivity with Custom Statuses!</a></div>
                            </div>
                    </div>
                </div>
    ...
    ?>
    <?php     
    $rm_promo_banner_title = "Unlock Custom Statuses, Note, Print, Block Email/IP and Send Message options by upgrading";
