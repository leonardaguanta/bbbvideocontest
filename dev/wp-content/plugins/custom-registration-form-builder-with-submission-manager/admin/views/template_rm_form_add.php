...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        $form->addElement(new Element_Color("<b>" . RM_UI_Strings::get('LABEL_SUBMIT_BTN_COLOR') . "</b>(Does not works with Classic form style):", "form_submit_btn_color", array("id" => "rm_", /*"value" => $data->model->form_options->form_submit_btn_color,*/ "longDesc" => RM_UI_Strings::get('HELP_ADD_FORM_SUB_BTN_FG_COLOR'))));
        ...
        $form->addElement(new Element_Radio("<b>" . RM_UI_Strings::get('LABEL_EXPIRY') . "</b>", "form_expired_by", array('submissions' => 'By Submissions', 'date' => 'By Date', 'both' => 'Set Both (Whichever is earlier)'), array("id" => "rm_", /*"value" => $data->model->form_options->form_expired_by,*/ "longDesc" => RM_UI_Strings::get('HELP_ADD_FORM_EXPIRE_BY'))));
