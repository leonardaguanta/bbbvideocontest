...
<!-- Joyride Magic begins -->
    <ol id="rm-form-sett-dashboard-joytips" style="display:none">
        ...
        <li>Remember - each form will have its own dashboard; accessible by clicking DASHBOARD on its form card. That's how you reached here, right? But once you're here, you do not need to go back to open another form's dashboard. You can just...</li>
               <li data-class="rm-grid-title" data-options="tipAdjustmentY:-15">This of course, is your currently selected form's name. And...</li>
        ...
        <li data-id="rm-customfields-icon" data-options="tipAdjustmentX:25">While the <b>Design</b> takes care of the look of your form, <b>Pages and Field</b> decide its content. A form is made up of fillable fields. For example, Name, Email, Address etc. You can create, edit and manage fields from this section.</li>

         <li data-id="rm-design-icon" data-options="tipAdjustmentX:25">This is where you tweak individual elements of your form to make the overall look match with your website's theme or experiment with different combinations. </li>
        ...
        <li data-id="rm-general-settings" data-options="tipAdjustmentX:25">General Settings cover the basic properties of your form, like its Name, Description etc.</li>                
        <li data-id="rm-accounts-icon" data-options="tipAdjustmentX:25">Now this is important! This section decides properties of  WordPress User accounts created when a person submits this form.</li>
        <li data-id="rm-postsubmit-icon" data-options="tipAdjustmentX:25">Things do not end with submitting the form. You may want to show a success message or a token number or perhaps redirect the user to another page with relevant information. All that and more is configured through this section.</li>
        <li data-id="rm-autoresponder-icon" data-options="tipAdjustmentX:25">Automatically send users an email notification with customized content after they have submitted the form.</li>
        <li data-id="rm-limits-icon" data-options="tipAdjustmentX:25">Limits allow you to set, well, limits to your form. Once a limit is reached, the form goes to <i>expired</i> state. This will also be visible on the form card. Limits are useful if you have limited submission slots or if registration is only open before a specified date.</li>
        <li data-id="rm-email-templates" data-options="tipAdjustmentX:25">You can tweak content of the emails being sent out to the users filling this form from here.</li>                

        <li data-class="rm-sub-icon-tour" data-options="tipAdjustmentX:30"> Like this very important form <b>Inbox</b>. This is where all user submission records for <b><?php echo $data->form->get_form_name(); ?></b> go.</li>
        <li data-class="rm-sub-icon-tour-badge" data-options="tipAdjustmentX:-20;tipAdjustmentY:-20">See this badge? This tell you the number of time users have filled and submitted this form. Right now there are <b><?php echo $data->sub_count; ?></b> submissions associated with your form <b><?php echo $data->form->get_form_name(); ?></b></li>
         <li data-id="rm-outbox-icon" data-options="tipAdjustmentX:20">All the outgoing emails to the users are recorded in this area.</li>        
        ...
        <li data-id="rm-analytics-icon" data-options="tipAdjustmentX:20"><b>Analytics</b>, as the name suggests, collects and displays all the stats related to this form as table, graphs and charts.</li>
                ...
                <li data-id="rm-automate-icon"  data-options="tipAdjustmentX:25">This is a powerful system which allows you to 'program' the form to do essential workflow tasks for you. We recommend visiting it after you have familiarized yourself with other areas of the form.</li>        

        <li data-id="rm-emailusers-icon" data-options="tipAdjustmentX:25">This section allows you to email all the users who have submitted this form. You'll find this useful for broadcasting announcements and sending bulk updates.</li>
...
<!--        <li data-id="rm-sidebar-pages" data-options="tipLocation:left;tipAdjustmentX:-45;tipAdjustmentY:-30">Your form can be spread over multiple pages. This number shows the count of pages in your form.</li>-->
        ...
        <li data-id="rm-sidebar-submissions" data-options="tipLocation:left;tipAdjustmentX:-45;tipAdjustmentY:-30">Inbox badge counts the number of times the form has been filled and submitted. Do not confuse this with Users. A single user can submit a form multiple times. You can download all submission records as CSV file by clicking Download Records and open it as spreadsheet inside a desktop program like MS Excel, Apple Numbers etc.</li>
...
<div class="rm-form-configuration-wrapper">
    ...
    <div class="rm-grid difl"> 
        ...
        <!-- dummy spacer -->
        <div class="rm-grid-spacer" id="rm-section-icons"> </div>
        <!--    -->
        ...
        <div class="rm-grid-section dbfl" id="rm-thirdparty-section">
            ...
            <!--
            <div class="rm-grid-icon difl"> 
                <a href="?page=rm_form_sett_aweber&rm_form_id=<?php echo $data->form_id; ?>" class="rm_fd_link">   
                    <div class="rm-grid-icon-area dbfl">
            ...
            <div class="rm-grid-icon difl">  
                <a href="?page=rm_form_sett_ccontact&rm_form_id=<?php echo $data->form_id; ?>" class="rm_fd_link">  
                    <div class="rm-grid-icon-area dbfl">
                        <img class="rm-grid-icon dibfl" src="<?php echo RM_IMG_URL; ?>constant-contact.png">
                    </div>
                    <div class="rm-grid-icon-label dbfl"><?php echo RM_UI_Strings::get('NAME_CONSTANT_CONTACT'); ?></div>
    ...
    <div id="rm_fd_promo_popup" class="rm-modal-view" style="display: none;">
        ...
        <div class="rm-modal-wrap rm-fd-promo-popup">
            ...
            <div class="rm-modal-titlebar ">
                ...
                Extend Power of RegistrationMagic
                </div>
            ...
            <div class="rm-modal-footer"><a href="?page=rm_support_premium_page" target="_blank">More Information</a></div>
        </div>
