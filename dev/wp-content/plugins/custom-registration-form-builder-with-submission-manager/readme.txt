...
RegistrationMagic is a powerful WordPress user registration plugin that gives you TOTAL CONTROL of user registrations on your website. You can create different forms for user registrations, each with different pre-defined fields. You can also set up payments for paid user registrations. A Front-End user registration area allows your users to login, reset password, check transactions, download submissions etc.
...
There’s also a full fledged User Managed module integrated with RegistrationMagic. It goes a step ahead of default WordPress User manager by connecting user registration and payment activities with individual user accounts.
...
* Social login using Facebook, Linkedin, Microsoft, Twitter, Instagram and Google Accounts (User registration form with front-end login)
