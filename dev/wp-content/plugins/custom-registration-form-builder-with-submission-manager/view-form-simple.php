...
if ( $enable_captcha == 'yes' ) {
	...
	if ( isset( $_POST["recaptcha_response_field"] ) ) {
		...
		if ( $resp->is_valid ) {
			...
			<div class="error"
			     align="center"> <?php _e( 'Sorry, you didn\'t enter the correct captcha code.', $textdomain ); ?> </div>
			<br/>
			<br/>
			<br/>
			<?php
	...
	if ( ! empty( $reg1 ) ) {
		foreach ( $reg1 as $row1 ) {
			if ( ! empty( $row1 ) ) {
				...
				} else if ( isset( $_POST[ $Customfield ] ) ) {
			...
			<div id="crf-form">
				<div id="main-crf-form">
					<div class="main-edit-profile"
					     align="center"><?php _e( 'Sorry, the username or e-mail is already taken.', $textdomain ); ?>
						<br/>
						<br/>

						<div align="center" style="width:430px;"><a href="javascript:void(0);"
						                                            onclick="javascript:history.back();"
						                                            title="Registration">
								<div
									class="UltimatePB-Button"><?php _e( 'Go back to Registration.', $textdomain ); ?></div>
							</a> &nbsp; <a href="<?php echo site_url(); ?>">
								<div
									class="UltimatePB-Button"><?php _e( 'Go back to Home-Page.', $textdomain ); ?></div>
							</a></div>
					</div>
				</div>
			</div>
	...
	<div id="crf-form">
		<form enctype="multipart/form-data" method="post" action="" id="crf_contact_form" name="crf_contact_form">
			...
			<div class="crf_contact_form">
				<?php if ( $form_type == 'reg_form' ): ?>
					<div class="formtable">
						...
						<div class="crf_input crf_required">
							<input type="text" size="20" onblur="javascript:validete_userName();"
							       onkeyup="javascript:validete_userName();" onfocus="javascript:validete_userName();"
							       onchange="javascript:validete_userName();"
							       value="<?php echo ( ! empty( $_POST['user_name'] ) ) ? $_POST['user_name'] : ''; ?>"
							       class="input" id="user_name" name="user_name">

							<div class="reg_frontErr crf_error_text custom_error" style="display:none;"
							     id="nameErr"></div>
						</div>
					</div>
					<div class="formtable">
						...
						<div class="crf_input crf_required crf_email">
							<input type="text" onblur="javascript:validete_email();"
							       onkeyup="javascript:validete_email();" onfocus="javascript:validete_email();"
							       onchange="" size="25"
							       value="<?php echo ( ! empty( $_POST['user_email'] ) ) ? $_POST['user_email'] : ''; ?>"
							       class="input" id="user_email" name="user_email">
						...
						<div class="formtable">
							...
							<div class="crf_input crf_required crf_password">
								<input id="inputPassword" name="inputPassword" type="password"
								       onfocus="javascript:document.getElementById('user_confirm_password').value = '';"/>

								<div id="complexity" class="default" style="display:none;"></div>
								<div id="password_info"
								     class="password-pro"><?php _e( 'At least 7 characters please!', $textdomain ); ?></div>
					...
					} else//If auto password generation is enabled then this will create a random password
					{
						...
						?>
						<input id="inputPassword" name="inputPassword" type="hidden"
						       value="<?php echo $random_password; ?>"/>
						<input id="user_confirm_password" name="user_confirm_password"
						       value="<?php echo $random_password; ?>" type="hidden"/>
						<?php
					}
					?>
				<?php endif; ?>
				...
				foreach ( $reg1 as $row1 ) {
					...
					if ( $row1->Type == 'heading' ) {
						...
						<div class="formtable crf_heading">
							<h1 name="<?php echo $key; ?>"
							    class="<?php echo $row1->Class; ?>"><?php echo $row1->Value; ?></h1>
						</div>
						<?php
					}
					if ( $row1->Type == 'paragraph' ) {
						...
						<div class="formtable crf_paragraph">
							...
							<p name="<?php echo $key; ?>"
							   class="<?php echo $row1->Class; ?>"><?php echo $row1->Option_Value; ?></p>
						</div>
					<?php }
					if ( $row1->Type == 'term_checkbox' ) {
						?>
						<div class="formtable">
							<div class="crf_label <?php if ( $row1->Require == 1 ) {
								echo 'crf_termboxrequired';
							} ?>">
								<input type="checkbox" value="<?php echo 'yes'; ?>" id="<?php echo $key; ?>"
								       name="<?php echo $key; ?>" class="regular-text <?php echo $row1->Class; ?>">
								<label
									for="<?php echo $key; ?>"><?php echo $row1->Name; ?><?php if ( $row1->Require == 1 ) {
										echo '<sup class="crf_estric">*</sup>';
									} ?></label>

								<div class="reg_frontErr custom_error crf_error_text" style="display:none;"></div>
								<textarea disabled rows="4"
								          class="textareaa"><?php echo $row1->Description; ?></textarea>
					...
					if ( $row1->Type == 'DatePicker' ) {
						...
						<div class="formtable">
							...
							<div class="crf_input <?php if ( $row1->Require == 1 ) {
								echo 'crf_required';
							} ?>">
								<input type="text" class="MyDate regular-text <?php echo $row1->Class; ?>"
								       maxlength="<?php echo $row1->Max_Length; ?>" value="<?php echo $value; ?>"
								       id="<?php echo $key; ?>"
								       name="<?php echo $key; ?>" <?php if ( $row1->Readonly == 1 ) {
									echo 'readonly';
								} ?>>
					...
					if ( $row1->Type == 'text' ) {
						...
						<div class="formtable">
							...
							<div class="crf_input <?php if ( $row1->Require == 1 ) {
								...
								<input type="text" class="regular-text <?php echo $row1->Class; ?>"
								       maxlength="<?php echo $row1->Max_Length; ?>" value="<?php echo $value; ?>"
								       id="<?php echo $key; ?>"
								       name="<?php echo $key; ?>" <?php if ( $row1->Readonly == 1 ) {
									echo 'readonly';
					...
					if ( $row1->Type == 'email' ) {
						...
						<div class="formtable">
							...
							<div class="crf_input crf_email <?php if ( $row1->Require == 1 ) {
								echo 'crf_required';
							} ?>">
								<input type="text" class="regular-text <?php echo $row1->Class; ?>"
								       maxlength="<?php echo $row1->Max_Length; ?>" value="<?php echo $value; ?>"
					...
					if ( $row1->Type == 'number' ) {
						...
						<div class="formtable">
							...
							<div class="crf_input crf_number <?php if ( $row1->Require == 1 ) {
								echo 'crf_required';
							} ?>">
								<input type="text" class="crf_number regular-text <?php echo $row1->Class; ?>"
								       maxlength="<?php echo $row1->Max_Length; ?>" value="<?php echo $value; ?>"
								       id="<?php echo $key; ?>"
								       name="<?php echo $key; ?>" <?php if ( $row1->Readonly == 1 ) {
									echo 'readonly';
					...
					if ( $row1->Type == 'textarea' ) {
						...
						<div class="formtable">
							...
							<div class="crf_input <?php if ( $row1->Require == 1 ) {
								echo 'crf_textarearequired';
							} ?>">
								<textarea class="regular-text <?php echo $row1->Class; ?>"
								          maxlength="<?php echo $row1->Max_Length; ?>" cols="<?php echo $row1->Cols; ?>"
								          rows="<?php echo $row1->Rows; ?>" id="<?php echo $key; ?>"
								          name="<?php echo $key; ?>" <?php if ( $row1->Readonly == 1 ) {
									echo 'readonly';
						...
						<div class="formtable">
							...
							<div class="crf_input <?php if ( $row1->Require == 1 ) {
								...
								foreach ( $arr_radio as $radio ) {
									...
									<input type="radio" class="regular-text  <?php echo $row1->Class; ?>"
									       value="<?php echo $radio; ?>" <?php if ( $value != "" ) {
										if ( in_array( $radio, $array_value ) ) {
											echo 'checked';
										}
									} ?> id="<?php echo $key; ?>"
									       name="<?php echo $key; ?>" <?php if ( $row1->Readonly == 1 ) {
					...
					if ( $row1->Type == 'checkbox' ) {
						...
						<div class="formtable">
							...
							<div class="crf_checkbox <?php if ( $row1->Require == 1 ) {
								echo 'crf_checkboxrequired';
							} ?>">
								<?php
								$arr_radio   = explode( ',', $row1->Option_Value );
								$radio_count = 1;
								foreach ( $arr_radio as $radio ) {
									...
									<input type="checkbox" class="regular-text <?php echo $row1->Class; ?>"
									       ...
									       name="<?php echo $key . '[]'; ?>" <?php if ( $value != "" ) {
										if ( in_array( $radio, $array_value ) ) {
											echo 'checked';
										}
									} ?> <?php if ( $row1->Readonly == 1 ) {
										echo 'disabled';
									} ?>>
									<?php $radio_count ++;
								} ?>
					...
					if ( $row1->Type == 'select' ) {
						...
						<div class="formtable">
							...
							<div class="crf_input crf_select <?php if ( $row1->Require == 1 ) {
								echo 'crf_select_required';
							} ?>">
								<select class="regular-text <?php echo $row1->Class; ?>" id="<?php echo $key; ?>"
								        name="<?php echo $key; ?>" <?php if ( $row1->Readonly == 1 ) {
									echo 'disabled';
								} ?>>
									<?php
									...
									foreach ( $arr as $ar ) {
										?>
										<option value="<?php echo $ar; ?>" <?php if ( $ar == $value ) {
											echo 'selected';
										} ?>><?php echo $ar; ?></option>
										<?php
									}
					...
					if ( $row1->Type == 'country' ) {
						...
						<div class="formtable">
							...
							<div class="crf_input crf_select crf_country <?php if ( $row1->Require == 1 ) {
								echo 'crf_select_required';
							} ?>">
								<select class="regular-text <?php echo $row1->Class; ?>" id="<?php echo $key; ?>"
								        name="<?php echo $key; ?>" <?php if ( $row1->Readonly == 1 ) {
				...
				<?php if ( $enable_captcha == 'yes' ) : ?>
					<div class="formtablee" align="center">
						<div
							class="crf_input crf_input_captcha"> <?php echo recaptcha_get_html( $publickey, $error ); ?> </div>
					</div>
					<div class="reg_frontErr custom_error crf_error_text" id="divrecaptcha_response_field"
			...
			<div class="UltimatePB-Button-area crf_input crf_input_submit">
				<input type="submit" value="<?php if ( $submit_button_label != "" ) {
					echo $submit_button_label;
				} else echo 'Submit' ?>" class="crf_contact_submit" id="submit" name="submit">
