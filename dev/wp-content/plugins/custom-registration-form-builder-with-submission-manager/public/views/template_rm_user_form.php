...
// Checking if captcha is enabled
            ...
            $form->addElement(new Element_Button($btn_label != "" ? $btn_label : "Submit", "submit", array("bgColor" => "#$data->submit_btn_bgcolor", "fgColor" => "#$data->submit_btn_fgcolor")));
            ...
            else
            {
                ...
                if ($data->expiry_details->state !== 'perpetual')
                {
                    ...
                    else
                    {
                        ...
                        {
                             case 'both':
                                $exp_str .= '<div class="rm-formcard-expired">' . ($data->expiry_details->sub_limit - $data->expiry_details->remaining_subs) . ' out of ' . $data->expiry_details->sub_limit . ' filled and ' . $data->expiry_details->remaining_days . ' days to go </div>';
