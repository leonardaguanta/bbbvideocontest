    ...
    public static function get($identifier) {
        ...
        switch ($identifier) {
            ...
            case 'LABEL_ADD_OTHER':
                return __("Allow users to input custom value. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htoptions'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPT_IN_CB':
                return __("Display a checkbox, allowing users to opt-in for subscription. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/mailchimp-integration-2/#htmcoptin'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPT_IN_CB_TEXT':
                return __("This text will appear with the opt-in checkbox. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/mailchimp-integration-2/#htmcoptintext'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_WORDPRESS_DEFAULT_EMAIL_REQUIRED_MESSAGE':
             ...
             case 'LABEL_SMTP_FAIL_MESSAGE':
                 return __('Failed!! <a href="https://registrationmagic.com/wordpress-registration-not-sending-email/" target="_blank"> Need Help </a>','custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_PRICE_FIELD':
                return __("Please Enter a value greater than zero. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/add-product/#htprodprice'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_HIDE_TOOLBAR':
                return __("Hides the top WordPress admin bar for logged in users. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings-2/#hthidewpbar'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_CURRENCY_SYMBOL_HELP':
                return __("Choose position of the currency sign. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/payments/#htcurrencysymbol'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_SUB_LIMIT_ANTISPAM_HELP':
                return __("Limits how many times a form can be submitted from a device within a day. Helpful to prevent spams. Set it to zero(0) to disable this feature. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/global-overrides/#htdevicelimit'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'INVALID_EMAIL':
                return __("Invalid username or email. Please try again.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FORM_TITLE':
                return __("Name of your form. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings/#htformtitle'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FORM_DESC':
                return __('Not visible on front end by default. Can be displayed using MagicWidgets. <a target="_blank" class="rm-more" href="https://registrationmagic.com/knowledgebase/general-settings/#htformdesc">More</a>', 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FORM_CREATE_WP_USER':
                return __("Selecting this will register the user in WP Users area. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/accounts/#htcreateaccount'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FORM_WP_USER_ROLE_AUTO':
                return __("WordPress User Role that will be assigned to the user. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/accounts/#htassignrole'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FORM_WP_USER_ROLE_PICK':
                return __("Adds a new field to the form asking users to pick a role themselves. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/accounts/#htrolechoice'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FORM_ALLOWED_USER_ROLE':
                return __("Only the checked roles will appear for selection on the form. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/accounts/#htroleselect'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FORM_CONTENT_ABOVE_FORM':
                return __("Optional rich text content that will be displayed above the form fields. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings/#htcontent'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FORM_SUCCESS_MSG':
                return __("Display a message after the form has been successfully submitted. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/post-submission/#htsuccessmessage'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FORM_UNIQUE_TOKEN':
                return __("A Unique Token number is assigned to the submission and also emailed to the user if auto-reply is turned on. Token number is visible in the submission records. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/post-submission/#httokennumber'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FORM_REDIRECT_AFTER_SUB':
                return __("Redirect the user to a new page after submission (and success message). <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/post-submission/#htredirection'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FORM_AUTO_RESPONDER':
                return __("Turns on auto responder email for the form. After successful submission a customizable email is sent to the user. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/auto-responder/#htautoreply'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FORM_AUTO_RESP_SUB':
                return __("Subject of the mail sent to the user. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/auto-responder/#htsubject'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FORM_AUTO_RESP_MSG':
                return __("Content of the email to be sent to the user. You can use rich text and values the user submitted in the form for a more personalized message. If you are creating a new form, Add Fields drop down will be empty. You can come back after adding fields to the form. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/auto-responder/#htbody'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_FIELD_ICON_BG_ALPHA':
                return __("Change the opacity of icon's container. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htbacktransparent'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FORM_MC_LIST':
                return __("Required for connecting the form to a MailChimp List. To make it work, please set MailChimp in Global Settings &#8594; <a target='blank' class='rm_help_link' href='admin.php?page=rm_options_thirdparty'>External Integration</a>. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/mailchimp-integration-2/#htmclist'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FORM_AUTO_EXPIRE':
                return __("Select this if you want to auto unpublished the form after required number of submissions or reaching a specific date. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/limits/#htlimit'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FORM_EXPIRE_BY':
                return __("Select the parameters for auto unpublishing the form. You can also display this parameter above the form. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/limits/#htsetlimit'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FORM_AUTO_EXP_SUB_LIMIT':
                return __("The form will not be visible to the user after this number is reached. However, you can reset it later for extending restrictions. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/limits/#htlimitnum'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FORM_AUTO_EXP_TIME_LIMIT':
                return __("The last date on which this form will be visible. It will no longer accept submissions after this date. However, you can reset it later for extending limits. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/limits/#htlimitdate'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FORM_AUTO_EXP_MSG':
                return __("User will see this message when accessing the form. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/limits/#htlimitaction'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FIELD_LABEL':
                return __("Label of the field as it appears on forms and inside user accounts. This does not apply to fields without labels like Shortcode field. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htlabel'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FIELD_PLACEHOLDER':
                return __("This will appear inside the input box before user starts entering a value. Do not confuse it with default value. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htplaceholder'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FIELD_CSS_CLASS':
                return __("Apply a CSS Class defined in the theme CSS file or in Appearance &#8594; Editor. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htcssclass'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FIELD_MAX_LEN':
                return __("Maximum Allowed length (characters) of the user submitted value. Leave blank for no limit. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htmaxlength'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FIELD_IS_REQUIRED':
                return __("Make this field mandatory to be filled. Form will give user an error if he/ she tries to submit the form without filling this field. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htisreq'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FIELD_SHOW_ON_USERPAGE':
                return __("Display's this field's value inside RegistrationMagic's User Manager area. It also displays the value on frontend User Account area created by RegistrationMagic's shortcode. Please note, RegistrationMagic's account area is different from WordPress' user page. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htaddtouser'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FIELD_OPTIONS_SORTABLE':
                return __("Options for user to choose from. Drag and drop to arrange their order inside the list. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htoptions'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FIELD_TnC_VAL':
                return __("Paste your terms and conditions here. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#httandc'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FIELD_FILETYPE':
                return __("Restricts the type of file allowed to be attached. If you leave it blank, extensions defined in Global Settings --> General will be used. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htallowedfiles'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FIELD_PRICE_FIELD':
                return __("Select the product created in &quot;Products&quot; section of RegistrationMagic. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htproduct'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FIELD_OPTIONS_COMMASEP':
                return __("Options for drop down list. Separate multiple values with a comma(,). <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htoptions'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_GEN_THEME':
                return __("Select visual style of your forms. Classic applies a set neutral tone which looks pleasing with all kinds of WordPress themes. Match My Theme will let forms pick visual elements automatically from your active WordPress theme. When this is selected, you can also override the design of individual forms in Form Dashboard --> Build --> Design. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings-2/#htformstyle'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_GEN_LAYOUT':
                return __("Select the position of field labels and columns for your forms. Two column layouts will work better with themes that offer wide content area. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings-2/#htlayout'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_GEN_FILETYPES':
                return __('Restrict the type of files allowed to be attached to your File type fields. You will need to define extension of the file types. For multiple extensions, seperate using pipe "|". <a target=\'_blank\' class=\'rm-more\' href=\'https://registrationmagic.com/knowledgebase/general-settings-2/#htfiletypes\'>More</a>', 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_GEN_FILE_MULTIPLE':
                return __("Allows users to attach multiple files to your single file field. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings-2/#htuploadmultifile'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_GEN_REG_URL':
                return __("Users will be automatically redirected to this page when clicking &quot;Register&quot; links on your site. Do make sure you have a registration form inserted inside the page you select. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings-2/#htdefregpage'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_POST_SUB_REDIR':
                return __("Choose the page you want to redirect the user to after successful login. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings-2/#htloginredirect'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_ASPM_ENABLE_CAPTCHA':
                return __("Shows recaptcha above the submit button. It verifies if the user is human before accepting submission. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/global-overrides/#htrepatcha'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_USER_AUTOGEN':
                return __("Creates and sends the users random password instead of allowing them to set one on the form. After selecting this, password field will not appear on the forms. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/user-accounts-2/#htautogenpass'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_USER_AUTOAPPROVAL':
                return __("Automatically activates user accounts after submission. Uncheck it if you wish to manually activate every user individually. Manual Activations can be done through User Manager, or by clicking activation link in admin email notification or setting up and Automation Task. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/global-overrides/#htautoapprove'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_ARESP_NOTE_NOTIFS':
                return __("Email notification will be send to the users if you add a User Note to one of their submissions. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/email-notifications-2/#htnotifyuser'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_ARESP_ADMIN_NOTIFS':
                return __("An email notification will be sent to Admin of this site for every form submission. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/email-notifications-2/#htnotifyadmin'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_ARESP_RESPS':
                return __("Add people who you want to receive notifications for form submissions. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/email-notifications-2/#htdefinemanual'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_ARESP_SMTP_HOST':
                return __("Specify host address for SMTP. For example, smtp.gmail.com . <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/email-notifications-2/#htsmtphost'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_ARESP_SMTP_PORT':
                return __("Specify port number for SMTP. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/email-notifications-2/#htsmtpport'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_ARESP_SMTP_ENCTYPE':
                return __("Specify the type of encryption used by your SMTP service provider. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/email-notifications-2/#htencryttype'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_ARESP_SMTP_AUTH':
                return __("Please check this if authentication is required at SMTP server. Also, provide credential in the following fields. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/email-notifications-2/#htauthenticate'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_ARESP_FROM_DISP_NAME':
                return __("A name to identify the sender. It will be shown as &quot;From: MY Blog &lt;me@myblog.com&gt;&quot;.Use tag {{user}} to dynamically pick name from the form, if it has profile fields for name; or if the user is already registered, from his/ her WP Profile. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/email-notifications-2/#htsendername'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_THIRDPARTY_FB_ENABLE':
                return __("Adds 'Login Using Facebook' button to the login form. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/external-integrations/#htenablefb'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_THIRDPARTY_FB_APPID':
                return __("More information about Facebook App ID <a target='blank' class='rm_help_link' href='https://developers.facebook.com/docs/apps/register'>Here</a>. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/external-integrations/#htenablefb'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_THIRDPARTY_MC_ENABLE':
                return __("This will allow you to fetch your MailChimp lists in Form Dashboard --> Integrate --> MailChimp and map selective fields to your MailChimp fields. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/external-integrations/#htenablemailchimp'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_THIRDPARTY_MC_API':
                return __("This will allow you to fetch your MailChimp lists in Form Dashboard --> Integrate --> MailChimp and map selective fields to your MailChimp fields. <a target='blank' class='rm_help_link' href='http://kb.mailchimp.com/accounts/management/about-api-keys'>HERE</a>. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/external-integrations/#htenablemailchimp'>More</a>", 'custom-registration-form-builder-with-submission-manager');
                
            case 'HELP_OPTIONS_PYMNT_PROCESSOR':
                return __("Select all the payment system(s) you want to use for accepting payments. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/payments/#htpayprocessor'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_PYMNT_TESTMODE':
                return __("This will put RegistrationMagic payments on test mode. Useful for testing and troubleshooting payment system. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/payments/#htenabletestmode'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_PYMNT_PP_EMAIL':
                return __("Your PayPal account email, to which the payments will be sent. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/payments/#htppemail'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_PYMNT_CURRENCY':
                return __("Default Currency for accepting payments. Usually, this will be default currency in your PayPal,Stripe or Authorize.Net account. Please visit this <a target='_blank' href='https://support.authorize.net/authkb/index?page=content&id=A414'>LINK</a> to check currencies supported by Authorize.net. Make sure the currency you select is supported by the payment processor(s) you are using. Not all currencies work well with all payment processor. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/payments/#htdefcurrency'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_PYMNT_PP_PAGESTYLE':
                return __("Optional checkout page style. Checkout page styles are created in your PayPal account for customized checkout experience. More information <a target='_blank' href='https://www.paypal.com/ca/cgi-bin/webscr?cmd=p/pop/cowp_overview'>HERE</a>. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/payments/#htpppagestyle'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_PRICE_FIELD_LABEL':
                return __("This name will not be visible when you will add product in a form. If you wish to show this name on the form, make sure while adding this product to a form you enter same field label as the product name. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/add-product/#htprodname'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_INVITES_SUB':
                return __("Subject for the message you are sending to the users. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/bulk-email/#htsubject'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_INVITES_BODY':
                return __("Content of the message your are sending to the users of selected form. You can use values from form fields filled by the users from “Add Fields” dropdown for personalized message. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/bulk-email/#htbody'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_SHOW_PROG_BAR':
                return __("Show Form Limits above the Form?", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_GEN_PROGRESS_BAR':
                return __('Shows form filling status above the form when Limits are turned on. For example, "2 out 50 registrations complete" or "2 days to go before registration ends". <a target="_blank" class="rm-more" href="https://registrationmagic.com/knowledgebase/global-overrides/#htexpirecount">More</a>', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_USER_SEND_PASS':
                return __("Send users an email with their selected username and password after successful registration. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/user-accounts-2/#htuserpassemail'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_SEND_SUB_TO_URL_CB':
                return __("Pushes submitted data to external server page using HTTP POST protocol. This could be useful for maintaining another database for submissions. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/post-submission/#htexternalurl'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_PYMNT_STRP_API_KEY' :
                return __("Secret and publishable keys are used to identify your Stripe account. You can grab the test and live API keys for your account under <a href='https://dashboard.stripe.com/account/apikeys' target='blank'>Your Account > API Keys</a>.  <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/payments/#htstripeapi'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_THIRDPARTY_GGL_API':
                return __("You will need a Google maps API Key to make 'Map' and 'Address' type fields work with Google Maps. To generate an API Key <a target='blank' class='rm_help_link' href='https://console.developers.google.com/flows/enableapi?apiid=maps_backend,geocoding_backend,directions_backend,distance_matrix_backend,elevation_backend&keyType=CLIENT_SIDE&reusekey=true'>CLICK HERE</a>. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/external-integrations/#htenablegmaps'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_BAN_IP_HELP':
                return __("Enter IP Address to ban. Separated multiple addresses by empty space. Wildcard(?) allowed (for IPv4 addresses only). For example: 127.233.12?.01? will ban all IPs from 127.233.120.010 to 127.233.129.019. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/security-settings-2/#htbanip'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_BAN_EMAIL_HELP':
                return __("Enter Email Address to ban. Separated multiple addresses by empty space. Wildcard(* and ?) allowed. For example: joh*@gmail.com will ban all submissions done using gmail domain and start with 'joh'. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/security-settings-2/#htbanemail'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_BAN_USERNAME_HELP':
                return __("User will not be able to register using these Usernames. Separate multiple usernames using space or new line (Enter). <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/security-settings-2/#htblacklist'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FIELD_HELP_TEXT':
                return __("This is displayed inside a fade-in tooltip box to the users when they brings cursor above a field. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#hthelptext'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FIELD_SHORTCODE_TEXT':
                return __("Enter Shortcode here. Only single shortcode is supported. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htshortcode'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_CUSTOM_PW_RESTS':
                return __("Force custom rules for password that user choose during registration. Does not applies on auto-generated passwords. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/security-settings-2/#htenablepassrules'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'SUB_PDF_HEADER_IMG_HELP':
                return __("You can brand Submissions PDFs with your business logo. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings-2/#htpdflogo'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'SUB_PDF_HEADER_TEXT_HELP':
                return __("Adds a line of text under your logo on Submission PDF header (use as a note or part of your branding). <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings-2/#htlogotext'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_FORM_ACTRL_DATE':
                return __("User will be asked to input a date before accessing form. Useful for setting age based restrictions. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/progress-access-control/#htaccesscontrol'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_FORM_ACTRL_ROLE':
                return __("Only users with specified roles will be able to view form. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/progress-access-control/#htenableuserrole'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_FORM_ACTRL_DATE_QSTN':
                return __("This question will be asked to user for entering a date. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/progress-access-control/#htquestiondate'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_FORM_ACTRL_PASS_QSTN':
                return __("This question will be asked to user for entering passphrase. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/progress-access-control/#htquestionpassphrase'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_FORM_ACTRL_DATE_TYPE':
                return __("Type of the limits. User entered date must fall into the given date range or age range. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/progress-access-control/#htlimittype'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_FORM_ACTRL_ROLE_ROLES':
                return __("Only users with these roles will be able to access form. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/progress-access-control/#htselectuserrole'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_FORM_ACTRL_PASS_PASS':
                return __("The passphrase/secret code that user must enter to access the form. Separate multiple passphrases with pipe (|). <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/progress-access-control/#htpassphrase'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_FORM_ACTRL_FAIL_MSG':
                return __("If users are not authorised to access the form, they will see this message instead of the form. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/progress-access-control/#htaccessdenied'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_FIELD_ICON':
                return __("Display an icon before the label of this field. You can style the icon below. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#hticon'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_FIELD_ICON_FG_COLOR':
                return __("Color of the icon. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#hticoncolor'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_FIELD_ICON_BG_COLOR':
                return __("Background color of the icon's container. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htbackcolor'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_FIELD_ICON_SHAPE':
                return __("Define shape of the icon's container. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htshape'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_SHOW_FLOATING_ICON':
                return __("Makes it easier for you to let your users to sign in, register and access their data WITHOUT going through process of setting up shortcodes and custom menu links! <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/magic-popup-button/#htmagicpopup'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FORM_AUTO_LOGIN':
                return __("User will be logged in automatically on next page refresh after successfull account creation. You may set up auto-redirect after submission. Note that it will work only if auto-approval is enabled. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/accounts/#htforcelogin'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_CONSTANT_CONTACT_OPTION_INTEGRATION':
                return __("Enable Constant Contact Integration. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/external-integrations/#htenablecc'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FIELD_TnC_CB_LABEL':
                return __('This will appear along with the checkbox. You might want to set it up to say something like "I accept". '."<a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htchecklabel'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_SELECT_FORM_TYPE_REG':
                return __("For those who want to create WP User accounts after form submission or Manual Approval. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings/#htformtype'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_SELECT_FORM_TYPE_NON_REG':
                return __("For those who do not want to create WP User accounts with form submissions. Ideal for offline registration processes or using this form as simple contact/enquiry form. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings/#htformtype'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_POST_EXP_ACTION':
                return __("What happens when user opens a form after reaching restriction limit? <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/limits/#htlimitaction'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_POST_EXP_FORM':
                return __("Displays another form instead of original form after restriction limits are reached. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/limits/#htlimitaction'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'TEXT_FAB_ICON_HELP':
                return __("Display an image on MagicPopup Button instead of the default 'Users' icon. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/magic-popup-button/#htmpicon'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_IS_PAID_ROLE':
                return __("User will be charged for signing up for this role. User will be redirected to checkout after submitting the form and role will be assigned on successful payment. (Make sure that you have configured payment option in Global Settings->Payments). <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/user-roles/#htsignupcharge'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_SUBMISSION_ON_CARD':
                return __("The number on form card badge will count based on this criteria. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings-2/#htbadgecount'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_SHO_FAB_LINK':
                return __("Add a custom link of your choice on the MagicPopup Menu. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/magic-popup-button/#htcustomlinks'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_LABEL_IS_FIELD_EDITABLE':
                return __("If you have set up a frontend User area for your users and want them to login and edit the form submission after they have submitted it, you must turn this on. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#hteditfield'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'MSG_OPT_IN_DEFAULT_STATE':
                return __("Default state of the opt in check box. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/mailpoet-integration/#htmpdefstate'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_SHOW_ASTERIX':
                return __("Show the red Asterisk(*) on top right side of the label. A common symbol for required fields. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings-2/#htasterisk'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_SHOW_SUBMISSION_TAB':
                return __("Add Submissions tab to MagicPopup Menu. Users can check their form submissions by clicking on it. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/magic-popup-button/#htregtab'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_SHOW_PAYMENT_TAB':
                return __("Add Payments tab to MagicPopup Menu. Users can check their form payments by clicking on it. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/magic-popup-button/#htpaymenttab'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_SHOW_DETAILS_TAB':
                return __("Add User details tab to MagicPopup Menu. Users can check their user account page by clicking on it. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/magic-popup-button/#htdetailstab'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'LABEL_VISITS':
                return __("Visits", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_THIRDPARTY_GP_CLIENT_ID':
                return __("More information about Google Client ID <a target='blank' class='rm_help_link' href='https://developers.google.com/identity/sign-in/web/devconsole-project'>HERE</a>. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/external-integrations/#htenablegoogle'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_THIRDPARTY_LINKEDIN_ENABLE':
                return __("Adds 'Login Using LinkedIn' button to the login form. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/external-integrations/#htenablelinkedin'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_THIRDPARTY_LIN_API_KEY':
                return __("More information about LinkedIn Client ID/ API Key <a target='blank' class='rm_help_link' href='https://developer.linkedin.com/support/faq'>HERE</a>. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/external-integrations/#htenablelinkedin'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_THIRDPARTY_WINDOWS_ENABLE':
                return __("Adds 'Login Using Microsoft' button to the login form. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/external-integrations/#htenablemslive'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_THIRDPARTY_WIN_CLIENT_ID':
                return __("More information about Microsoft App/ Client ID. <a target='blank' class='rm_help_link' href='https://msdn.microsoft.com/en-in/library/bb676626.aspx'>HERE</a>. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/external-integrations/#htenablemslive'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'FD_LABEL_REDIRECTION':
                return __("Redirection. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/post-submission/#htredirection'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_THIRDPARTY_TWITTER_ENABLE':
                return __("Adds 'Login Using Twitter' button to the login form. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/external-integrations/#htenabletwitter'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_THIRDPARTY_TW_CONSUMER_KEY':
                return __("More information about Twitter Consumer Key <a target='blank' class='rm_help_link' href='https://apps.twitter.com/'>HERE</a>. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/external-integrations/#htenabletwitter'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_OPTIONS_THIRDPARTY_TW_CONSUMER_SEC':
                return __("More information about Twitter Consumer Secret <a target='blank' class='rm_help_link' href='https://apps.twitter.com/'>HERE</a>. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/external-integrations/#htenabletwitter'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_THIRDPARTY_INSTAGRAM_ENABLE':
                return __("Adds 'Login Using Instagram' button to the login form. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/external-integrations/#htenableinsta'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_POST_LOGOUT_REDIR' :
                return __("User will be redirected to this page after logging out. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings-2/#htlogoutredirect'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_SHOW_TOTAL_PRICE' :
                return __("Enables a real-time display of total amount when you have multiple products added to the form. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings/#httotalprice'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_PRICE_FIELD_ALLOW_QUANTITY' :
                return __("A quantity box will appear on the form allowing users to purchase more than one item. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/add-product/#htquantity'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FORM_NU_EMAIL_MSG' :
                return __("Content of the email to be sent to the newly created user. You can use rich text and values the user submitted in the form for a more personalized message. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/email-templates/#htnewemailbody'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FORM_USER_ACTIVATED_MSG' :
                return __("Content of the email to be sent to the activated user. You can use rich text and values the user submitted in the form for a more personalized message. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/email-templates/#htactemailbody'>More</a>", 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_ADD_FORM_ACTIVATE_USER_MSG' :
                return __("Content of the email to be sent to admin with activation link. You can use rich text and values the user submitted in the form for a more personalized message. If you are creating a new form, Add Fields drop down will be empty. You can come back after adding fields to the form. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/email-templates/#htuseremailbody'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FORM_ADMIN_NS_MSG' :
                return __("Content of the email to be sent to admin on new submission. You can use rich text and values the user submitted in the form for a more personalized message. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/email-templates/#htsubmitemailbody'>More</a>"
            ...
            case 'HELP_FOPTIONS_ARESP_ADMIN_NOTIFS':
                return __("An email notification will be sent to recipients of this form for every submission. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/global-overrides/#htsendnotice'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'CRON_DISABLED_WARNING_INVITATION':
                return __('Wordpress cron is disabled. This feature will not work. <a target="__blank" href="https://codex.wordpress.org/Editing_wp-config.php#Disable_Cron_and_Cron_Timeout">More info.</a>', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_SHOW_ON_FORM':
                return __("Displays price on the form while user fills it. If turned off, user will be directly taken to checkout. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/add-product/#htproddisplayprice'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FIELD_IS_UNIQUE':
                return __("Mark this field as unique. No two users can submit same value for this field. Any subsequent attempt for submission with duplicate value will show a message. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htisunique'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_SUB_LIMIT_IND_USER':
                return __("Limits how many times a form can be submitted by same user. Set it to zero(0) to disable this feature. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings/#htsubmitlimit'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_GEN_REDIRECT_ADMIN_TO_DASH':
                return __("If enabled, admin users will always be redirected to admin dashboard irrespective of page/url selected above. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/general-settings-2/#htredirectadmin'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_WI_VIDEO_URL':
                 return __("URL of the YouTube Video you wish to add to your form. For example, https://www.youtube.com/watch?v=Eq9x-e3phHo",'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_WIDGET_YT_AUTOPLAY':  
             ...
             case 'HELP_ADD_FIELD_MULTI_LINE_TYPE':
                 return __("Allows user to add extra text area boxes to the form for submitting different values. Useful where a field requires multiple user input values. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/new-field/#htfieldtype'>More</a>",'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_AR_US_FROM_EMAIL':
                 return __("The sender's email address in the message header that the user will receive. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/email-notifications-2/#htfromemail'>More</a>",'custom-registration-form-builder-with-submission-manager');
            
            case 'HELP_OPTIONS_AR_AD_FROM_EMAIL':
                 return __("The sender's email address in the message header that the admin will receive. You can also set this dynamically to the email of the user submitting the form by using tag {{useremail}}. This can be useful if you wish to forward submissions to a helpdesk or ticketing software. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/email-notifications-2/#htfromemail'>More</a>",'custom-registration-form-builder-with-submission-manager');
            
            case 'LABEL_ST_NUMBER':
                 return __("Street Number",'custom-registration-form-builder-with-submission-manager');
            
            case 'HELP_ROLE_KEY':
                return __("Key value of the Role which will be saved in database. This will not be visible on front-end. This can be same as the Role name. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/user-roles/#htrolekey'>More</a>",'custom-registration-form-builder-with-submission-manager'); 
                
            case 'HELP_ROLE_NAME':
                return __("Name of the Role that will be displayed on the front-end and the dashboard. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/user-roles/#htrolename'>More</a>",'custom-registration-form-builder-with-submission-manager');
            
            case 'HELP_ROLE_PERMISSION':
                return __("Inherit viewing and editing permissions for this custom Role from one of default WordPress roles. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/user-roles/#htinheritpermissions'>More</a>",'custom-registration-form-builder-with-submission-manager');
            
            case 'SMTP_TESTMAIL_HELP':
                return __("Sends an email to this address for testing outing messages. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/email-notifications-2/#htemailfortest'>More</a>",'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ACC_ACT_METHOD':
                 return __("Select the action to be performed when a user submits a registration form for the first time. Content of the account verification email can be modified in form Dashboard->Email Templates.",'custom-registration-form-builder-with-submission-manager');
            ...
            case 'FIELD_HELP_TEXT_IMAGEV':
                return __("Insert an image in your form",'registration-gold');
            
            case 'LABEL_CAPTION':
                return __("Caption",'registration-gold');
            
            case 'LABEL_LINK':
                return __("Link",'registration-gold');
             
            case 'LABEL_EFFECTS':
                return __("Effects",'registration-gold');
                
            case 'LABEL_BORDER_SHAPE':
                return __("Shape",'registration-gold');
                
            case 'LABEL_DISPLAY_POP':
                return __("Display as pop up",'registration-gold');
            
            case 'LABEL_SIZE':
                return __("Size",'registration-gold');
                
            case 'FIELD_HELP_TEXT_PRICEV':
                return __("Display total price of products selected by user in the form",'registration-gold');
                
            case 'FIELD_HELP_TEXT_SUB_COUNDOWN':
                return __("If you have set form limits, you can display the limit status using this widget",'registration-gold');    
